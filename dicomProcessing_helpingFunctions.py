...
def thresholding(data, show_diff=False, save=False):
    """
...
def median_filter(data, show_diff=False, save=False):
    """
...
def resize_scan(data, out_width=512, out_height=512, show_diff=False):
    ...
    :return: Resized data
    """
    new = skimage.transform.resize(data, (out_width, out_height), preserve_range=True, anti_aliasing=False, order=4)
...
def remove_background(data, show_diff=False):
    raise NotImplementedError("To be done yet")
